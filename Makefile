...
$(BUILD_BINARY_DIR):
	cmake -B $(BUILD_BINARY_DIR) -S . -G $(CMAKE_BUILD_GENERATOR) -DCMAKE_BUILD_TYPE=$(CMAKE_BUILD_TYPE) -DCMAKE_C_COMPILER=$(CMAKE_C_COMPILER) -DCMAKE_EXPORT_COMPILE_COMMANDS=1 -DCMAKE_INSTALL_PREFIX=$(BUILD_BINARY_DIR)
